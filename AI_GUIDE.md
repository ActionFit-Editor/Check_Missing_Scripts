# AI Guide - Check Missing Scripts
...
- Package ID: `com.actionfit.checkmissingscripts`
- Display name: Check Missing Scripts
- Repository: `https://github.com/ActionFit-Editor/Check_Missing_Scripts.git`
- Current package version at generation time: `1.0.3`
- Unity version: `6000.2`

## Purpose

Check Missing Scripts scans assets for missing MonoBehaviour references. Use `README.md`, `package.json`, package source files, and `Editor/PackageInfo/ActionFitPackageInfo_SO.asset` together to understand the user-facing workflow and catalog metadata.
...
- changing files under `Packages/com.actionfit.checkmissingscripts/`
- diagnosing `Check Missing Scripts` behavior in a consuming project
- preparing a release for `com.actionfit.checkmissingscripts`
...
- Menu family: `Tools/ActionFit/Missing Scripts/*`.
- Use this guide when changing missing MonoBehaviour scan targets, cleanup behavior, report output, or safety prompts.
- Missing-script cleanup can mutate project assets; prefer scan/report workflows before destructive cleanup.
